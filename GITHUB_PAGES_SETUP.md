...
AgentWork Simulator frontend can be deployed to GitHub Pages, with the API hosted separately on Render/Railway.
...
4. Your API will be at: `https://agentwork-simulator-api.onrender.com`
...
- name: Prepare static files
  env:
    API_URL: 'https://agentwork-simulator-api.onrender.com'  # Your API URL
  run: |
    # ... rest of the script
```
...
window.API_BASE = 'https://agentwork-simulator-api.onrender.com';
```
...
- Test API directly: `curl https://agentwork-simulator-api.onrender.com/`
