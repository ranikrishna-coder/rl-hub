...
4. Your API will be at: `https://rl-hub-api.onrender.com`
...
- name: Prepare static files
  env:
    API_URL: 'https://rl-hub-api.onrender.com'  # Your API URL
  run: |
    # ... rest of the script
```
...
- **API**: `https://rl-hub-api.onrender.com` (or your API URL)
...
window.API_BASE = 'https://rl-hub-api.onrender.com';
```
...
- Test API directly: `curl https://rl-hub-api.onrender.com/`
...
5. ✅ Access your app at `https://ranikrishna-coder.github.io/rl-hub/`
